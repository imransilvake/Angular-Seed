...
@Component({
	selector: 'app-guest-offers-form',
	templateUrl: './guest-offers-form.component.html',
	styleUrls: ['./guest-offers-form.component.scss']
})

export class GuestOffersFormComponent implements OnInit, OnDestroy {
	...
	public onSubmitForm() {
		...
		// form
		const formPayload: GuestOfferInterface = {
			...id,
