...
export const AppServices: { [moduleName: string]: { [name: string]: AppServicesInterface } } = {
	...
	Management: {
		...
		Client_Form_HGA_Hotel_Fetch: { serviceUrl: '/management/module/hotel/:hotelId/app/:appId' },
		Client_Form_HGA_HotelGroup_Fetch: { serviceUrl: '/management/module/group/:groupId/app/:appId' },
		Client_Form_HGA_Hotel_Update: { serviceUrl: '/management/module/hotel' },
		Client_Form_HGA_HotelGroup_Update: { serviceUrl: '/management/module/group' }
	}
};
